...
export default class Product extends Component {
    render() {
        const {ProductId, ProductName, img, ProductPrice, CategoryId, inCart} = this.props.product;
        return (
            ...
            <div className="card">
                ...
                <div className="card-footer d-flex justify-content-between">
                    ...
                    <h5 className="text-blue font-italic mb-0">
                        <span className="mr-1">${ProductPrice}</span>
                    </h5>
                </div>
            </div>
            </ProductWrapper>
...
// inline css
// had to use hexcode with card-footer hover, rgba would not work here for some reason but there were no errors
